...
public class MusicFragment extends Fragment implements SwitchButton.OnCheckedChangeListener {
...
//        mLanguageView = view.findViewById(R.id.sb_setting_language);
//        mPhoneView = view.findViewById(R.id.sb_setting_phone);
//        mPasswordView = view.findViewById(R.id.sb_setting_password);
//        mCleanCacheView = view.findViewById(R.id.sb_setting_cache);
//        mAutoSwitchView = view.findViewById(R.id.sb_setting_switch);
//
